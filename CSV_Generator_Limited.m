...
% limitador de linhas
num_linhas = min(limite, size(nomematriz, 1));
...
nome_arquivo = 'Oi_sou_s_planilha_de_teste_Limitada.csv'; % Aqui basta alterar qual o nome que vc deseja que o arquivo csv tenha, dá pra trocar o formato do arquivo, mas n recomendo pq deu erro.
